...
export class StudentsSubjectsMapper {
    ...
    public static ToEntity(studentsSubjectsModel: StudentsSubjects): StudentsSubjectsEntity {
    ...
    public static ToEntities(studentsSubjectsModels: StudentsSubjects[]): StudentsSubjectsEntity[] {
        let studentsSubjectsEnties: StudentsSubjectsEntity[];
        if (studentsSubjectsModels && studentsSubjectsModels.length > 0) {
            studentsSubjectsEnties = studentsSubjectsModels.map(studentsSubjectsModel => {
    ...
    public static ToModel(studentsSubjectsEntity: StudentsSubjectsEntity): StudentsSubjects {
        let studentsSubjects: StudentsSubjects = {
    ...
    public static ToModels(studentsSubjectsEntities: StudentsSubjectsEntity[]): StudentsSubjects[] {
        let studentsSubjectsModels: StudentsSubjects[];
        if (studentsSubjectsEntities && studentsSubjectsEntities.length > 0) {
            studentsSubjectsModels = studentsSubjectsEntities.map(studentsSubjectsEntitity => {
