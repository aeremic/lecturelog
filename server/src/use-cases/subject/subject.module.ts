...
@Module({
    imports: [forwardRef(() => UserModule), LectureModule, LoggerModule, ProfessorsGroupsModule, StudentsGroupsModule, TypeOrmModule.forFeature([Subject, SubjectGroup, StudentsSubjectGroups, ProfessorsSubjectGroups])],
    providers: [
        SubjectUseCases,
        {
